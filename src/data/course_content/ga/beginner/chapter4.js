  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          instruction:
            "Listen to the audio and select the correct English number.",
        ...
        },
        {
          ...
          explanation:
            "Etɛ = Three. The pattern counts from one to five.",
        },
      ],
    },

    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation:
            "Kpaanyɔ = Eight. The pattern counts from six to nine.",
        },
      ],
    },

    {
      ...
      questions: [
        ...
        },
        {
          ...
          explanation:
            "You heard 'Nyɔŋma kɛ enumɔ' which means Fifteen in Ga.",
        },
        {
          id: 409,
          type: "drag_drop",
          instruction:
            "Complete the pattern by dragging the correct Ga number.",
          sentence:
            "Nyɔŋma kɛ ekome, Nyɔŋma kɛ enyɔ, ___, Nyɔŋma kɛ ejwɛ, Nyɔŋma kɛ enumɔ",
          blankId: "blank1",
          items: [
          ...
          explanation:
            "Nyɔŋma kɛ etɛ = Thirteen. The pattern counts from eleven to fifteen.",
        },
      ],
    },

    {
      ...
      questions: [
        ...
        },
        {
          ...
          hints: ["Three tens"],
          explanation:
            "You heard 'Nyɔŋmai etɛ' which means Thirty in Ga.",
        },
        {
          id: 412,
          type: "drag_drop",
          instruction:
            "Complete the pattern by dragging the correct Ga number.",
          sentence:
            "Nyɔŋmai enyɔ, Nyɔŋmai etɛ, ___, Nyɔŋmai enumɔ",
          blankId: "blank1",
          items: [
          ...
          explanation:
            "Nyɔŋmai ejwɛ = Forty. The pattern counts by tens.",
        },
      ],
    },
      ...
      questions: [
        ...
        },
        {
          ...
          instruction:
            "Complete the pattern by dragging the correct Ga number.",
          sentence:
            "Nyɔŋmai ekpaa, Nyɔŋmai kpawo, ___, Nyɔŋmai nɛɛhu",
          blankId: "blank1",
          items: [
          ...
          explanation:
            "Nyɔŋmai kpaanyɔ = Eighty. The pattern counts by tens.",
        },
      ],
    },

    {
      ...
      words: [
        "Nyɔŋmai enyɔ kɛ enyɔ",
        "Nyɔŋmai etɛ kɛ nɛɛhu",
        "Nyɔŋmai enumɔ kɛ ekome",
        "Nyɔŋmai nɛɛhu kɛ kpaanyɔ",
        "Oha kɛ nyɔŋmai enumɔ",
      ],
      vocabulary: [
        {
          id: 81,
      ...
      questions: [
        {
          ...
          explanation:
            "You heard 'Oha kɛ nyɔŋmai enumɔ' which means One hundred and fifty in Ga.",
        },
        {
          id: 417,
          type: "drag_drop",
        ...
        },
        {
          ...
          explanation:
            "Nyɔŋmai enumɔ kɛ ekome = Fifty-one in Ga.",
        },
      ],
    },
      ...
      questions: [
        {
          ...
          explanation:
            "Ŋmɛjii enyiɛ atswa? = What time is it? in Ga.",
        },
        {
          id: 420,
          type: "listening_multiple_choice",
          ...
          explanation:
            "You heard 'Atswa ŋmɛjii etɛ' which means 'It is three o'clock' in Ga.",
        },
        {
          id: 421,
          type: "drag_drop",
...

    {
      ...
      description:
        "Learn the Ga words for days, weeks, today, tomorrow, and yesterday",
...

    {
      ...
      questions: [
        ...
        },
        {
          ...
          type: "drag_drop",
          instruction:
            "Complete the pattern by dragging the correct Ga word.",
          ...
          explanation:
            "Soo = Thursday. The pattern shows the days of the week in order.",
        },
      ],
    },
  ],
  ...
  review: {
    ...
    questions: [
      ...
      },
      {
        ...
        hints: ["Seven tens"],
        explanation:
          "You heard 'Nyɔŋmai kpawo' which means Seventy in Ga.",
      },
      {
        id: 506,
        type: "drag_drop",
        instruction:
          "Complete the pattern by dragging the correct Ga number.",
        sentence:
          "Nyɔŋmai enyɔ, ___, Nyɔŋmai ejwɛ, Nyɔŋmai enumɔ",
        blankId: "blank1",
        items: [
          { id: "opt1", text: "Nyɔŋmai ekpaa" },
      ...
      },
      {
        ...
        instruction:
          "Complete the pattern by dragging the correct Ga number.",
        sentence:
          "Nyɔŋma kɛ ekome, Nyɔŋma kɛ enyɔ, Nyɔŋma kɛ etɛ, ___, Nyɔŋma kɛ enumɔ",
        blankId: "blank1",
        items: [
