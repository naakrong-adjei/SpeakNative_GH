export default {
  ...
  sections: [
    {
      ...
      icon: "map-outline",
      description:
        "Learn how to plan a trip and ask for transport information in Twi",
      words: [
        "Mepɛ sɛ metu kwan kɔ Kumasi",
        "Bɔs gyinabea wɔ he?",
        "Ɛgye berɛ sɛn?",
        "Mehia taksi",
      ],
      ...
      questions: [
        ...
        },
        {
          ...
          explanation:
            "Mepɛ sɛ metu kwan kɔ Kumasi = I want to travel to Kumasi in Twi.",
        },
        {
          id: 104,
          ...
          explanation:
            "You heard 'Mehia taksi' which means 'I need a taxi' in Twi.",
        },
        {
          id: 102,
          type: "listening_multiple_choice",
          ...
          explanation:
            "You heard 'Bɔs gyinabea wɔ he?' which means 'Where is the bus station?' in Twi.",
        },
      ],
    },

    {
      ...
      words: [
        "Mepa wo kyɛw gyina ha",
        "Obi te saa akonnwa yi so?",
        "Mensiane wɔ he?",
      ],
      vocabulary: [
        {
      ...
      questions: [
        ...
        },
        {
          ...
          hints: ["gyina ha = stop here"],
          explanation:
            "You heard 'Mepa wo kyɛw gyina ha' which means 'Stop here please' in Twi.",
        },
        {
          id: 106,
          type: "listening_multiple_choice",
          ...
          hints: ["akonnwa = seat"],
          explanation:
            "You heard 'Obi te saa akonnwa yi so?' which means 'Is this seat taken?' in Twi.",
        },
      ],
    },

    {
      ...
      icon: "ticket-outline",
      description:
        "Learn phrases for dealing with fares and travel problems in Twi",
      ...
      questions: [
        {
          ...
          explanation:
            "Ɛkwan no ka yɛ sɛn? = How much is the fare? in Twi.",
        },
        {
          id: 109,
          type: "multiple_choice",
        ...
        },
        {
          ...
          hints: ["gyaa me = left me"],
          explanation:
            "You heard 'Bɔs no gyaa me' which means 'I missed the bus' in Twi.",
        },
        {
          id: 110,
          type: "listening_multiple_choice",
          ...
          hints: ["ka = fare/cost"],
          explanation:
            "You heard 'Ɛkwan no ka yɛ sɛn?' which means 'How much is the fare?' in Twi.",
        },
      ],
    },

    {
      ...
      questions: [
        ...
        },
        {
          ...
          hints: ["nyɛ = bad"],
          explanation:
            "You heard 'Ɛkwan no nyɛ' which means 'The road is bad' in Twi.",
        },
      ],
    },
  ],
  ...
  review: {
    ...
    description:
      "Review all the travel and transport vocabulary you've learned",
    questions: [
      {
        id: 120,
        type: "multiple_choice",
      ...
      },
      {
        ...
        hints: ["metu kwan = travel"],
        explanation:
          "Mepɛ sɛ metu kwan kɔ Kumasi = I want to travel to Kumasi.",
      },
      {
        id: 124,
        type: "listening_multiple_choice",
        ...
        hints: ["berɛ = time"],
        explanation:
          "You heard 'Ɛgye berɛ sɛn?' which means 'How long does it take?'.",
      },
      {
        id: 121,
        type: "multiple_choice",
      ...
      },
      {
        ...
        hints: ["Mensiane = I get down"],
        explanation:
          "You heard 'Mensiane wɔ he?' which means 'Where do I get down?'.",
      },
      {
        id: 122,
        type: "multiple_choice",
